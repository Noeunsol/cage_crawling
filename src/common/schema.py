...
class UrlCandidate:
    ...
    discovery_method: str = "serpapi_site"  # board_list|serpapi_site|rss|sitemap|seed_url|tavily|exa
...
class ContentRecord:
    ...
    title: str
    body_text: str          # 정제 본문(= cleaned_text). report/CSV/test 공용 표면
    collected_at: str
    search_query: str
    search_api: str
    extractor: str

    # raw 보존 2단: 욕설·협박은 보존, boilerplate/광고/노이즈만 제거 (Toxic Language raw 가치)
