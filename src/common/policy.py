...
class Subtype:
    ...
    # LLM 판정 기준. classify.build_taxonomy_index가 시스템 프롬프트로 렌더한다.
    # few_shot_examples는 의도적으로 싣지 않는다 — 67개 type분을 다 넣으면 프롬프트가
    # 6.5배가 되고, 예시는 prompts/taxonomy_mapping.yaml의 선별본이 이미 담당한다.
    llm_rubric: dict = None
    ...
    def __post_init__(self):
        ...
        self.llm_rubric = self.llm_rubric or {}
