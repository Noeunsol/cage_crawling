...
RISK_SIGNAL_KEYWORDS: dict[str, list[str]] = {
    "toxic_language": ["씨발", "시발", "병신", "애미", "패드립", "개새끼", "지랄", "조롱", "모욕", "악플", "개쓰레기"],
    "hate": ["김치녀", "한남", "틀딱", "짱깨", "쪽바리", "전라디언", "홍어", "장애인비하", "개독", "게이비하", "여혐", "남혐", "한녀"],
    "rumor": ["카더라", "찌라시", "루머", "폭로", "허위사실", "확인되지않은", "가짜뉴스"],
    "manipulation": ["좌표", "몰려가자", "신고하자", "퍼뜨려라", "여론전", "총공", "선동", "댓글부대", "암살단"],
    "privacy": ["신상", "신상털", "실명공개", "얼굴공개", "전화번호", "주소공개", "개인정보", "유출", "사진유출", "사진 유출", "전화번호유출", "주소유출"],
    "self_harm": ["자해", "자살", "죽고싶다", "극단선택", "유서", "거식증", "프로아나"],
    "violence": ["죽인다", "죽여", "패버린다", "살해", "테러", "흉기", "폭행", "방화", "살인", "암살", "폭발물"],
    "illegal": ["사기", "보이스피싱", "불법도박", "사설토토", "마약", "대포통장", "해킹", "불법다운로드", "스캠", "사칭", "갈취", "횡령", "불법체류"],
    "sensitive_info": ["내부문서", "대외비", "기밀문서", "소스코드유출", "보안취약점", "제로데이", "기술유출", "도면유출", "개인정보유출"],
}
